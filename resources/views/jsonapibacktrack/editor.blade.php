...
<div class="row">
  ...
  <div class="col-lg-5">
    <select  id="functionality" class="form-control">
      ...
      <option>getJsonEquivalentPhpCodeOutput</option>
    </select>
  </div>
</div>
<div class="container">
    ...
    <script>
        ...
        function setUsageSample(){
          ...
          switch (selected_functionality) {
            ...
            usageSample = 'Just put the json string, In case the URI is too long,'+
            'you can locate the function and check it in the string code tester,'+
            'cuz the long URI gives an error.';
            break;
        ...
        function postJsonAndGetJavaCodes(){
          ...
          $.ajaxSetup({
              ...
              url: "{{ url('/') }}/Jsonapibacktrack/get_codes",
